...
public class Log {
	...
	public static void init(int n) throws IOException {
		filename = ".\\log\\generation-" + Integer.toString(n) + ".log";
		PrintWriter log = new PrintWriter(filename, "UTF-8");
		log.close();

		resultFilename = ".\\log-final\\generation-final-" + Integer.toString(n) + ".log";
	...
	public static void generateLog(int population) throws IOException {
		PrintWriter init = new PrintWriter(".\\log-final\\generation-final-0.log", "UTF-8");
